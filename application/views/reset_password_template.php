                ...
                <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="https://rakeshmandal.com" title="logo" target="_blank" style="text-decoration:none; color:rgba(17, 24, 39, 1); font-size:24px; font-weight:700;">
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px; background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                ...
                                <tr>
                                    <td style="padding:0 60px;">
                                        ...
                                        <a href="<?= base_url() . 'auth/verify?email=' . $to . '&token=' . urlencode($token) ?>" style="background:rgba(79, 70, 229, 1); text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff; text-transform:uppercase; font-size:14px; padding:10px 24px; display:inline-block; border-radius:5px; cursor:pointer">
