                ...
                <div class="w-full md:w-4/5">
                    <div class="md:border border-gray-200 rounded">
                        <ul class="list-reset flex overflow-auto border-b">
                            ...
                            <li class="p-0">
                                <a class="bg-white leading-10 inline-block py-2 px-4 text-indigo-600 hover:text-indigo-600 font-semibold active" data-select="three" id="three" href="">Proses</a>
                            </li>
                            <li class="p-0">
                        ...
                        <div class="content pb-5 md:px-5">
                            <?php if ($row_laporan != 0) { ?>
                                ...
                                ?>
                                    ...
                                    <div class="pt-6">
                                        <div id="tabs3" class="flex flex-col md:flex-row pb-5 border-b border-gray-200">
...
<script type="text/javascript">
    ...
    function showTab(e) {
        ...
        if (selectType == 'one') {
            ...
            $("#one,#two,#four").removeClass('text-indigo-600 active');
