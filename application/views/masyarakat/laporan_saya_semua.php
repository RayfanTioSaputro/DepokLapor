...
<body>
    ...
    <section class="w-full md:mt-8 px-6 mb-12 antialiased bg-white select-none">
                ...
                <div class="w-full md:w-4/5">
                    <div class="md:border border-gray-200 rounded">
                        <ul class="list-reset flex overflow-auto border-b">
                            <li class="p-0">
                                <a class="bg-white leading-10 inline-block py-2 px-4 text-indigo-600 hover:text-indigo-600 font-semibold active" data-select="one" id="one" href="">Semua</a>
                            </li>
                            <li class="p-0">
                                <a class="bg-white leading-10 inline-block py-2 px-4 text-gray-700  hover:text-indigo-600 font-semibold" data-select="two" id="two" href="<?= site_url('laporan_saya/belum') ?>">Belum</a>
                            </li>
                            <li class="p-0">
                        ...
                        <div class="content md:px-5">
                            <?php if ($row_laporan != 0) { ?>
                                ...
                                ?>
                                    <div class="pt-6">
                                        <div id="tabs1" class="flex flex-col md:flex-row pb-5 border-b border-gray-200">
                                            ...
                                            <div class="w-full md:w-12/12 ml-0 md:ml-4">
                                                ...
                                                <div class="mt-5 mb-8">
                                                    <div class="inline-block lg:inline text-xs font-medium leading-none text-gray-400 uppercase">
                                                        <i class="inline mb-1" data-feather="send" stroke-width="2" width="13px"></i>
                                                        <?= $l->tujuan_instansi ?>
                                                    </div>
                                                    <span class="mx-1 text-gray-400 hidden lg:inline-block">|</span>
                                                    <div class="inline-block lg:inline text-xs font-medium leading-none text-gray-400 uppercase">
                                    ...
                                    <div id="tabs2" class="d-none">
                                        <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ullamcorper, justo non pharetra pulvinar, risus dui fringilla ante, a auctor dolor massa sed ipsum. </p> -->
                                    </div>
...
<script type="text/javascript">
    ...
    function showTab(e) {
        ...
        if (selectType == 'one') {
            ...
            $("#two,#three,#four").removeClass('text-indigo-600 active');
            ...
            $("#one,#three,#four").removeClass('text-indigo-600 active').addClass('text-gray-700');
