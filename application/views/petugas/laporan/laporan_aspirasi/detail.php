...
?>
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent p-0">
                <li class="breadcrumb-item">
                    <a href="<?= site_url('laporan/aspirasi') ?>" class="inline h3 mb-0 text-primary">
                        Laporan Aspirasi
                    </a>
                </li>
        ...
        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-n3"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
    </div>
        ...
        <div class="col-12 col-md-10 col-lg-8">
            <div class="card mb-4 shadow">
                ...
                <div class="card-header d-flex align-items-center justify-content-between mb-3">
                    <a href="<?= site_url('laporan/aspirasi') ?>">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="<?= base_url('laporan/aspirasi/acceptLaporan') ?>" method="post">
