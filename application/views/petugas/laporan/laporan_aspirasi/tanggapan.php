        ...
        <div class="col-12 col-md-10 col-lg-10">
            <div class="card mb-4 shadow">
                <div class="card-header d-flex align-items-center justify-content-between mb-3">
                    <a href="<?= site_url('laporan/aspirasi/detail/' . $l->id) ?>">
                ...
                <div class="card-body pt-3 px-4">
                    <fieldset>
                        <form class="m-0" action="<?= base_url('laporan/aspirasi/tanggapan') ?>" method="post">
                            <div class="form-group">
                                <span>Tanggapan</span>
                                <textarea class="form-control mt-2" name="tanggapan" id="tanggapan" cols="30" rows="6" required></textarea>
                            </div>
