...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() . 'assets/css/petugas/sb-admin-2.css' ?>">
    <link rel="stylesheet" href="<?= base_url() . 'assets/css/petugas/style.css' ?>">
    <link rel="stylesheet" href="<?= base_url() . 'assets/vendor/loader/waitMe.min.css' ?>">
    ...
    <script src="<?= base_url() . 'assets/vendor/loader/waitMe.min.js' ?>"></script>
...
<body id="page-top">
    <?php if ($this->session->flashdata('message-success')) { ?>
        <div id="snackbar">
            <div class="bg-success shadow-lg text-center p-3 rounded">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-white sidebar sidebar-light border-right accordion" id="accordionSidebar">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon">
                    <img src="https://www.depok.go.id/img/lambang.png" alt="" style="max-width: 30px;">
                </div>
                <div class="sidebar-brand-text text-black mx-3">DepokLapor<span class="text-primary">!</span></div>
            </a>
            ...
            <!-- Nav Item - Dasbor -->
            <li class="nav-item <?= $page == "Dasbor" ? "active" : ""; ?>">
                <a class="nav-link <?= $page == "Dasbor" ? "disabled" : ""; ?>" href="<?= site_url('dasbor') ?>">
            ...
            <li class="nav-item <?= $page == "Masyarakat" ? "active" : ""; ?>">
                <a class="nav-link <?= $page == "Masyarakat" ? "disabled" : ""; ?>" href="<?= site_url('masyarakat') ?>">
            ...
            <!-- Nav Item - Petugas -->
            <li class="nav-item <?= $page == "Petugas" ? "active" : ""; ?>">
                <a class="nav-link <?= $page == "Petugas" ? "disabled" : ""; ?>" href="<?= site_url('petugas') ?>">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn btn-danger" href="<?= base_url('auth_petugas/logout') ?>">Keluar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
