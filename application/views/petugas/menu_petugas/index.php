    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="<?= site_url('petugas/add') ?>" class="btn btn-sm">
                    <h5 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-plus mr-2"></i>
                        Tambah
                    </h5>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="petugas/menu_petugas/edit_petugas/<?= $p->id; ?>" class="btn btn-info btn-sm">
                                            <i class="fas fa-pencil-alt" aria-hidden="true"></i>
                                        </a>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 mt-2">
                                                            ...
                                                            <input type="text" name="add_nama" class="form-control mt-2" value="<?= set_value('add_nama') ?>" required>
                                                            <?= form_error('add_nama', '<small class="text-danger">', '</small>'); ?>
                                                        </div>
                                                        <div class="col-sm-6 mt-2">
                                                            <span>No. Telpon</span>
                                                            <input type="telp" name="add_telp" class="form-control mt-2" value="<?= set_value('add_telp') ?>" required>
                                                            <?= form_error('add_telp', '<small class="text-danger">', '</small>'); ?>
                                                        </div>
                                                        <div class="col-sm-6 mt-2">
                                                            <span>Email</span>
                                                            <input type="email" name="add_email" class="form-control mt-2" value="<?= set_value('add_email') ?>" required>
                                                            <?= form_error('add_email', '<small class="text-danger">', '</small>'); ?>
                                                        </div>
                                                        <div class="col-sm-6 mt-2">
                                                            <span>Username</span>
                                                            <input type="text" name="add_username" class="form-control mt-2" value="<?= set_value('add_username') ?>" required>
                                                            <?= form_error('add_username', '<small class="text-danger">', '</small>'); ?>
                                                        </div>
                                                        <div class="col-sm-6 mt-2">
                                                            <span>Password</span>
                                                            <input type="password" name="add_password" class="form-control mt-2" value="<?= set_value('add_password') ?>" required>
                                                ...
                                                <fieldset disabled>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 form-group mt-2">
                                                            <span>Nama Lengkap</span>
                                                            <input type="text" name="nama" class="form-control mt-2" value="<?= $p->nama ?>">
                                                        </div>
                                                        <div class="col-sm-6 form-group mt-2">
                                                            <span>No. Telpon</span>
                                                            <input type="telp" name="telp" class="form-control mt-2" value="<?= $p->telp ?>" autocomplete="off">
                                                        </div>
                                                        <div class="col-sm-6 form-group mt-2">
                                                            <span>Email</span>
                                                            <input type="email" name="email" class="form-control mt-2" value="<?= $p->email ?>">
                                                        </div>
                                                        <div class="col-sm-6 form-group mt-2">
                                                            <span>Username</span>
                                                            <input type="text" name="username" class="form-control mt-2" value="<?= $p->username ?>">
                                                        </div>
                                                        <div class="col-sm-6 form-group mt-2">
                                                            <span>Level</span>
                                                            <input type="text" name="level" class="form-control mt-2" value="<?= $p->level ?>">
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                                ...
                                                <div class="modal-body">
                                                    <fieldset>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6 form-group mt-2">
                                                                <span>Nama Lengkap</span>
                                                                <input type="text" name="update_nama" class="form-control mt-2" value="<?= $p->nama ?>">
                                                            </div>
                                                            <div class="col-sm-6 form-group mt-2">
                                                                <span>No. Telpon</span>
                                                                <input type="telp" name="update_telp" class="form-control mt-2" value="<?= $p->telp ?>" autocomplete="off">
                                                            </div>
                                                            <div class="col-sm-6 form-group mt-2">
                                                                <span>Email</span>
                                                                <input type="email" name="update_email" class="form-control mt-2" value="<?= $p->email ?>">
                                                            </div>
                                                            <div class="col-sm-6 form-group mt-2">
                                                                <span>Username</span>
                                                                <input type="text" name="update_username" class="form-control mt-2" value="<?= $p->username ?>">
                                                            </div>
                                                            <div class="col-sm-6 form-group mt-2">
                                                                <span>Password</span>
                                                                <input type="password" name="update_password" class="form-control mt-2" value="<?= $p->password ?>">
                                                            </div>
                                                            <!-- <div class="col-sm-6 form-group mt-2">
                                                                <span>Level</span>
                                                                <input type="text" name="level" class="form-control mt-2" value="<?= $p->level ?>">
